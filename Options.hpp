...
public:
	...
	OPTION(bool, misc_doorspam, false);
	OPTION(bool, misc_radio, false);
	OPTION(int, misc_radiostation, 0);
	OPTION(bool, legit_drawfov, false);
	OPTION(float, rage_fieldofview, 0);
	OPTION(bool, indicators_enabled, false);
	OPTION(bool, zeusrange_enabled, false);
	...
	OPTION(bool, fullbright, false);
	OPTION(float, aspectratio, 0.1f);
	OPTION(bool, unload, 0);
	OPTION(float, misc_thirdperson_distance, 100);
	OPTION(int, misc_region_changer, 0);
	float glow_others_color[4] = { 1.f, 1.f, 1.f, 1.f };
	OPTION(bool, legit_backtrack, false);
	OPTION(float, legit_backtrackticks, 0);
	OPTION(bool, misc_fakeduck, false);
	OPTION(float, misc_fakeduck_chokedpackets, 0);
	OPTION(ButtonCode_t, misc_fakeduck_keybind, BUTTON_CODE_NONE);
	OPTION(ButtonCode_t, legit_aim_keybind1, BUTTON_CODE_NONE);
	OPTION(ButtonCode_t, legit_aim_keybind2, BUTTON_CODE_NONE);
	OPTION(bool, michaeljackson, false);
	/// new gang shit above 
	...
	OPTION(float, viewmodel_offset_y, 3);
...
//#endif
	...
	OPTION(int, hvh_show_real_angles, 1);

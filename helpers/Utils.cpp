...
namespace Utils
{
	...
	void RankRevealAll()
	{
		...
		static auto fnServerRankRevealAll = PatternScan(GetModuleHandle("client.dll"), "55 8B EC 51 A1 ? ? ? ? 85 C0 75 37");
	...
	void IsReady()
	{
		...
		static auto fnIsReady = PatternScan(GetModuleHandle("client.dll"), "55 8B EC 51 56 8B 35 ? ? ? ? 57 83 BE");
	...
	{
		static auto fnLoadNamedSkys = (void(__fastcall*)(const char*))PatternScan(GetModuleHandle("engine.dll"), "E8 ? ? ? ? 84 C0 74 2D A1");
